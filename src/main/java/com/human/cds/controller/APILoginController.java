...
//네이버 회원가입/로그인을 위함
	private String naverClientId = "apikey";
	private String naverClientPw = "apikey";
...
//카카오 회원가입/로그인을 위함
	private String kakaoClientId = "apikey";
...
//구글 회원가입/로그인을 위함
    private String googleClientId = "{apikey}";
    private String googleClientPw = "{apikey}";
